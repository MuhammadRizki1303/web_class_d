        ...
        <div class="row">
            ...
            if ($result) {
                while ($row = mysqli_fetch_assoc($result)) {
                    echo '<div class="col-12 col-md-4 mb-4" data-aos="fade-left">
                <div class="card rounded-10 p-3">
                    ...
                    <div class="card-body p-0 mt-3">
                        ...
                        <a href="../detailberita/detailkegiatan.php?id_kegiatan=' . $row['id_kegiatan'] . '" class="btn btn-success btn-sm">Lihat</a>
                    </div>
                </div>
            </div>';
                }
                    ...
                    <div class="col ms-auto">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Politeknik Negeri
                                    Lhokseumawe</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Teknologi Informasi
                                    dan
                                    Komputer</a></li>
