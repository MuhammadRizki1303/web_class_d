    ...
    <div class="container">
        ...
        <div class="row mt-4 mb-4">
            <div class="col-md-7 mt-auto mb-3 mb-md-0">
                <p class="text-violet-600 fw-medium mb-1 fs-5">Semua Kegiatan</p>
        ...
        <div class="row">
            <div class="col-12 col-md-3 col-lg-4 mb-4" data-aos="fade-left">
                <div class="card rounded-10 p-3">
                    ...
                    <div class="card-body p-0 mt-3">
                        ...
                        <p class="card-text mt-1"><small class="text-muted">semester 1</small></p>
                        <p class="card-text text-truncate">Makan-makan bersama setelah ujian akhir semester 1</p>
            ...
            <div class="col-12 col-md-3 col-lg-4 mb-4" data-aos="fade-left">
                <div class="card rounded-10 p-3">
                    ...
                    <img src="../assets/img/Pormatik.JPG" class="card-img-top rounded-10" style="height: 240px;" alt="">
                    <div class="card-body p-0 mt-3">
                        <h5 class="card-title m-0">
                            <p class="text-decoration-none link-dark text-truncate">
                                Kegiatan Pormatik
                        ...
                        <p class="card-text text-truncate">Lomba Tarik Tambang</p>
                        <a href="detailkegiatan.html" class="btn btn-success btn-sm">Lihat</a>
                    </div>
                </div>
            </div>
