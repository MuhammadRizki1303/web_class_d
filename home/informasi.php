        ...
        <div class="row justify-content-between">
                ...
                <div class="collapse" style="width:500px;" id="senin">
                    <div class="card card-body border-0 shadow">
                        <ol class="list-group list-group-numbered border-0 border-b">
                            <li class="list-group-item">A'fiyyah Salsabillah Nhazalta</li>
            ...
            <di class="col-12 col-md-2 col-lg-2 mb-4">
                ...
                <div class="collapse" id="selasa" style="width:500px;">
                    <div class="card card-body border-0 shadow">
                        <ol class="list-group list-group-numbered border-0 border-b">
                            <li class="list-group-item">Febri Fanisa</li>
                            <li class="list-group-item">Naomi Natalie Br Sembiring</li>
                            <li class="list-group-item">Nia Ramadhani</li>
                            <li class="list-group-item">Fachrul Rozi</li>
                            <li class="list-group-item">Jabal Akbar</li>
                            <li class="list-group-item">M.Akbar Zulfikar</li>
                        </ol>
                    </div>
                </div>
            </di justify-content-betweenv>
                ...
                <div class="collapse" id="rabu" style="width:500px;">
                    <div class="card card-body border-0 shadow">
                        <ol class="list-group list-group-numbered border-0 border-b">
                            ...
                            <li class="list-group-item">Safira Dara Sholehah</li>
                            <li class="list-group-item">Muhammad Abil</li>
                            <li class="list-group-item">Muhammad Alfitrah</li>
                            <li class="list-group-item">Muhammad Fadhilla</li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-2 col-lg-2 mb-4">
                ...
                <div class="collapse" id="kamis" style="width:500px;">
                    <div class="card card-body border-0 shadow">
                        <ol class="list-group list-group-numbered border-0 border-b">
                            <li class="list-group-item">Muhammad Rizki</li>
                            <li class="list-group-item">Sri Mutia</li>
                            <li class="list-group-item">Syahira Maharani</li>
                            <li class="list-group-item">Muhammad Maulana</li>
            ...
            <div class="col-12 col-md-2 col-lg-2 mb-4">
                ...
                <div class="collapse" id="jumat" style="width:500px;">
                    <div class="card card-body border-0 shadow">
                        <ol class="list-group list-group-numbered border-0 border-b">
                            <li class="list-group-item">Tasya Annisa</li>
                            <li class="list-group-item">Tri Kumala Sari</li>
                            <li class="list-group-item">Rachel Ardana Putra Ginting</li>
                            <li class="list-group-item">Reyhan Putra Syahmi</li>
                            <li class="list-group-item">Nurul Afika Simbolon</li>
